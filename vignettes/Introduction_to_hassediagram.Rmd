---
title: "From the Experimental Design to a Mixed Model Using the `hassediagram` Package in R"
author: ""
output: rmarkdown::html_vignette
bibliography: refs.bib
vignette: >
  %\VignetteIndexEntry{From the Experimental Design to a Mixed Model Using the `hassediagram` Package in R}
...
The Layout and Restricted Layout structures can be visualised using a generalisation of the Hasse Diagram. These diagrams can be generated using the `hassediagram` package in `R`.
...
An algorithmic approach that can be used to generate the Layout Structure is described in Bate and Chatfield (2016a). The Layout Structure can be visualised using a generalisation of the Hasse Diagram and the `hassediagram` package can be used to generate the diagram in `R`, see below.
