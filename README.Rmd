...
Bate ST, Chatfield MJ (2016a). "Identifying the structure of the experimental design." Journal of Quality Technology, 48(4), 343–364.

Bate ST, Chatfield MJ (2016b). "Using the structure of the experimental design and the randomization to construct a mixed model." Journal of Quality Technology, 48(4), 365–387.
...
hasselayout(datadesign=concrete, larger.fontlabelmultiplier=1.6, smaller.fontlabelmultiplier=1.3, table.out="Y")
...
hasserls(object=concrete_objects, randomisation.objects=concrete_rls, larger.fontlabelmultiplier=1.6, smaller.fontlabelmultiplier=1.3, table.out="Y", arrow.pos=8)
